...
export default function Menu({heading, username, img}: MenuProps) {
    return (
        <div className='menu'>
            <h2 className="menu__heading">{heading}</h2>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="menu__svg">
                <path
                    d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z"
                    stroke="#929EAE" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M21.0004 20.9999L16.6504 16.6499" stroke="#929EAE" strokeWidth="2" strokeLinecap="round"
            ...
            <button className="menu__btn">
                <img src={img} alt="avatar" className="menu__btn-avatar"/>
                <span className="menu__btn-user-name">{username}</span>
                <svg width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                     className="menu__btn-icon-dropdown">
                    <path
                        d="M12.6928 6.29395H8.27989H4.30612C3.62612 6.29395 3.28612 7.11561 3.76779 7.59729L7.43698 11.2665C8.02489 11.8544 8.98114 11.8544 9.56906 11.2665L10.9645 9.87104L13.2382 7.59729C13.7128 7.11561 13.3728 6.29395 12.6928 6.29395Z"
                        fill="currentColor"/>
                </svg>
            </button>
        </div>
